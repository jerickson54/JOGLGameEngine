...
public class MathUtil {
    ...
    public static double[][] translationMatrix(double[] v) {
    	double [][] translatedMatrix = new double[3][3];
    	
    	
    	translatedMatrix[0][0] = 1;
    	translatedMatrix[1][1] = 1;
    	translatedMatrix[2][2] = 1;
    	translatedMatrix[0][2] = v[0];
    	translatedMatrix[1][2] = v[1];
    ...
    public static double[][] rotationMatrix(double angle) {
    	...
    	translatedMatrix[0][0] = Math.cos(Math.toRadians(angle));
    	translatedMatrix[1][0] = Math.sin(Math.toRadians(angle));
    	translatedMatrix[0][1] = Math.sin(Math.toRadians(angle)) * -1;
    	translatedMatrix[1][1] = Math.cos(Math.toRadians(angle));
    ...
    public static double[][] scaleMatrix(double scale) {
    	...
    	translatedMatrix[0][0] = scale;
    	translatedMatrix[1][1] = scale;
    	translatedMatrix[2][2] = 1;
