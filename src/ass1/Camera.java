...
public class Camera extends GameObject {
    ...
    public void setView(GL2 gl) {
    	...
    	gl.glLoadIdentity();
    	//inverse actual values because camera
    	//make sure you inverse the order s*r*t
    	gl.glScaled(1.0/this.getGlobalScale(),1.0/this.getGlobalScale(),1);
    	gl.glRotated(this.getGlobalRotation()*-1,0,0,1);
    	gl.glTranslated(this.getGlobalPosition()[0]*-1,this.getGlobalPosition()[1]*-1,0);
